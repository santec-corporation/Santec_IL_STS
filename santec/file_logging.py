...
file_avg_repeated_measurement_data_results = f"avg_repeated_data_measurement_{formatted_datetime}.csv"
file_all_repeated_measurement_data_results = f"all_repeated_data_measurement_{formatted_datetime}.csv"
